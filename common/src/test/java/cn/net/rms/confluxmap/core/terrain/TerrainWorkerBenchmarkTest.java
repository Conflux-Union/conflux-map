...
@Tag("benchmark")
final class TerrainWorkerBenchmarkTest {
    @Test
    void refreshesLargeTallViewport() throws Exception {
        ...
        try (TerrainWorker worker = new TerrainWorker()) {
            worker.updateView(new TerrainView(41L, 1L, 64, 0, 23, 0, 23));
            ...
            System.out.printf("576-chunk in-process refresh: %.3f ms%n", millis);
