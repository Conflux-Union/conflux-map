...
public final class MapSyncCompatibility {
    ...
    private static final String ADVERTISEMENT =
        "|sync:1|wire:4.0|patch:3|region:1|patch:4|region:2|source-light:1|server-view:1";
    ...
    public record ClientHello(
        ...
        public ClientHello(
            ...
            final boolean supportsLegacyWire
        ) {
            this(
                predictorVersion, negotiationSupported, supportsCurrentWire,
                supportsLegacyWire, false
            );
        }
